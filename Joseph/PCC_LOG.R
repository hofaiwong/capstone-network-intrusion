...
alpha=30
alpha_max=50 #40 30
alpha_min=0.25*exp(5)   #2.0*exp(7)
df = read.table("C:/Users/Joseph/Desktop/NY/Final_project/training_fraud.txt", header = TRUE)
df$Prob=readRDS("C:/Users/Joseph/Desktop/NY/Final_project/logit.pred.train.proba.unshuffled.rds")

df_true_test=read.csv("C:/Users/Joseph/Desktop/NY/capstone-network-intrusion/data/KDDTest+.csv", header = FALSE,
                      stringsAsFactors = FALSE)
df_true_test$Prob=readRDS("C:/Users/Joseph/Desktop/NY/Final_project/logit.pred.test.proba.unshuffled.rds")

df_true_test$V42=as.numeric(as.factor(df_true_test$V42)) 
df_true_test<-subset(df_true_test,select=-c(V43))
...
df_train[,c(1:33)]=sapply(df_train[,c(1:33)],Standard_self)
...
hist(log(pcdistance_small),breaks=1000)
